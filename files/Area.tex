...
\begin{center} \includegraphics [scale=0.5] {area3.png} \end{center}

In the figure above, the area is $1/2$ $ah$ but also $1/2$ $cg$.
...
\begin{center} \includegraphics [scale=0.5] {area2.png} \end{center}

In this figure the areas of $\triangle ABC$ and $\triangle A'BC$ and equal, as are $\triangle DEF$ and $\triangle D'EF$.  Further, if $BC = EF$, then all four areas are equal.
