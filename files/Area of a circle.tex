...
So what we meant by as little as we please (above) is that $P$ can be made closer to $A$ than $T$ is, simply on the assumption that $T < A$.  Since this is an \emph{inscribed} polygon, we have
\[ A - P < A - T \]
We must have that
\[ -P < -T \]
\[ T < P \]
