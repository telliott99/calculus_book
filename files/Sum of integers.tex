...
As a view of what's ahead, let us use exactly the same method to determine the formula for
\[ S_n = 1^2 + 2^2 + \dots n^2 \]

Since the formula for the sum of integers has a square, we expect that this may be a cubic.  Write
\[ (k+1)^3 = k^3 + 3k^2 + 3k + 1 \]
