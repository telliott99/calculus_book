...
Archimedes lived and died (c.287-212 BC) in the city of Syracuse, found in the southeastern part of modern Sicily.  He is famous for many inventions, derivations and discoveries, but was evidently most proud of the formula for the volume of the sphere. 

The very simple result is that the volume is two-thirds that of a cylinder that just encloses the sphere.  

He was so proud of this discovery, he had a sculpture carved on his gravestone, which was near the Agrigentine gate of Syracuse.  The grave was found by the Roman orator Cicero, covered by brush after 137 years of neglect.  It is now lost again.
...
Now, imagine making a horizontal slice through each solid at an arbitrary but constant height $h$, shown by the red lines.  I hope you can visualize each of these red slices, which are perpendicular to the page, i.e. going into and coming out of the page.  

Each slice is a circle.  Any cross-section of a sphere is a circle.  For the cylinder and cone, cross-sections perpendicular to the axis are circles as well.  
...
so the areas add too:  \emph{sphere plus cone equals cylinder}.
...
\begin{center}
\includegraphics [scale=0.6] {archimedes2.png}
\includegraphics [scale=0.6] {SphereVolume.png}
\end{center}
